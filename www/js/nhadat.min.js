var App=angular.module("App","ngAnimate ngTouch ngSanitize ngRoute App.filters App.services App.directives App.controllers ui.bootstrap google-maps ngTagsInput".split(" ")).value("version","\u00a9 2001-2014 nhadat.com").value("Domain","http://nhadat.com").config(["$routeProvider","$locationProvider","$httpProvider",function(a,b,d){a.when("/login.html",{templateUrl:"html/login.html"});a.when("/update.html",{templateUrl:"html/update.html"});a.when("/newpassword.html",{templateUrl:"html/newpassword.html"});
a.when("/account.html",{templateUrl:"html/account.html"});a.when("/diadanh.html",{templateUrl:"html/group.html"});a.when("/agent.html",{templateUrl:"html/agent.html"});a.when("/search.html",{templateUrl:"html/search.html"});a.when("/t/:tagId",{templateUrl:"html/tag.html"});a.when("/p/:postId*",{templateUrl:"html/post.html"});a.when("/c/:commentId*",{templateUrl:"html/comment.html"});a.when("/profile/:profileId",{templateUrl:"html/profile.html"});a.when("/map/:mapId*",{templateUrl:"html/map.html"});
a.when("/contact/:contactId",{templateUrl:"html/contact.html"});a.when("/sale.html",{templateUrl:"html/sale.html"});a.when("/share.html",{templateUrl:"html/share.html"});a.when("/",{templateUrl:"html/welcome.html",controller:"WelcomeCtrl"});a.otherwise({redirectTo:"/"});d.defaults.headers.common={"X-Requested-With":"XMLHttpRequest"}}]).config(["$httpProvider",function(a){a.responseInterceptors.push(["$location","$q","Session","Flash",function(a,d,c,e){var f=function(a){return a},g=function(g){401===
g.status&&(c.unset("authenticated"),a.path("/login.html"),e.show({type:"error",msg:g.data.flash}));return d.reject(g)};return function(a){return a.then(f,g)}}])}]).config(["$compileProvider",function(a){a.aHrefSanitizationWhitelist(/^\s*(https?|mailto|tel|sms):/)}]).run(["$rootScope","$location","Auth","Flash",function(a,b,d,c){var e=["/diadanh.html","/sale.html","/share.html","/update.html","/account.html"],f=["/diadanh.html","/sale.html"];a.isPath="";a.$on("$routeChangeStart",function(g,h,k){a.isLogin=
