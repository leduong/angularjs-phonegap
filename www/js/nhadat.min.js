var App=angular.module("App","ngAnimate ngTouch ngSanitize ngRoute App.filters App.services App.directives App.controllers ui.bootstrap google-maps".split(" ")).value("version","\u00a9 2001-2014 nhadat.com").value("Domain","http://nhadat.com").config(["$routeProvider","$locationProvider","$httpProvider",function(a,b,d){a.when("/login.html",{templateUrl:"html/login.html"});a.when("/update.html",{templateUrl:"html/update.html"});a.when("/newpassword.html",{templateUrl:"html/newpassword.html"});a.when("/account.html",
