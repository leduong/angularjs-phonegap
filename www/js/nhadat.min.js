...
function(){return a.step===a.steps.length-1};a.CurrentStep=function(){return a.steps[a.step]};a.Label=function(){return a.isLastStep()?"\u0110\u0103ng":"Ti\u1ebfp theo"};a.Previous=function(){a.step-=a.isFirstStep()?0:1};a.Next=function(){a.isLastStep()?a.submit():(a.step+=1,1==a.step&&a.Tags())};a.submit=function(){if("undefined"!=typeof a.form.message){if(e.isLogin)return a.form.images=JSON.parse(f.get("files")),b.post("http://nhadat.com/api/message/create.html",a.form).success(function(a){g.show({type:"success",
msg:"\u0110\u0103ng tin th\u00e0nh c\u00f4ng."});c(function(){d.path("#/comment/"+a.message.link+".html")},500);f.unset("files")}).error(function(a){g.show({type:"danger",msg:a.flash})});alert("B\u1ea1n ch\u01b0a \u0111\u0103ng nh\u1eadp, vui l\u00f2ng \u0111\u0103ng nh\u1eadp.")}else a.step=0,g.show({type:"danger",msg:"B\u1ea1n vui l\u00f2ng nh\u1eadp n\u1ed9i dung \u0111\u1ec3 chia s\u1ebb."})};a.Tags=function(){var c=a.form.message;if(3<c.length)return b.post("http://nhadat.com/api/message/tags.html",
...
a.Tags=function(){return d.post("http://nhadat.com/api/message/tags.html",{content:a.form.message}).success(function(b){a.tags=b.tags})};a.toggle=function(b){var c=a.form.tag.indexOf(b);-1<c?a.form.tag.splice(c,1):a.form.tag.push(b)};a.suggests=function(){var b=a.form.address;6<b.length?a.busy||(a.busy=!0,d.post("http://nhadat.com/api/address.html",{address:b}).success(function(b){a.results=b.results;a.busy=!1}).error(function(){a.busy=!1})):a.results=[]};a.submit=function(){a.markers.length&&
(a.form.map=a.markers[0].latitude+", "+a.markers[0].longitude);if("undefined"!=typeof a.form.message&&20<=a.form.message.length)return d.post("http://nhadat.com/api/message/create.html",a.form).success(function(a){g.show({type:"success",msg:"B\u1ea1n \u0111\u00e3 \u0111\u0103ng tin th\u00e0nh c\u00f4ng."});b(function(){e.path("#/post/"+a.message.link+".html")},1E3);h.unset("files")}).error(function(b){a.step=0;g.show({type:"danger",msg:b.flash})});g.show({type:"danger",msg:"N\u1ed9i dung qu\u00e1 ng\u1eafn, \u00edt nh\u1ea5t 20 k\u00fd t\u1ef1."});
a.step=0}}]).controller("WelcomeCtrl",["$scope",function(a){}]).controller("TopicCtrl",["$scope","$http","$routeParams","TagService","Auth",function(a,b,c,d,e){a.isRealEstate=!0;a.isStatus=!0;a.user=e.user();a.isSwitch=function(b){b&&(a.isStatus||(a.isStatus=!0),a.isRealEstate||(a.isRealEstate=!0));return!b};b.post("http://nhadat.com/api/topic.html",{slug:c.topicId}).success(function(b){a.topic=b.topic;a.results=new d(b.topic.slug)})}]).controller("GroupCtrl",["$scope","$timeout","$log","$http",
...
a.position={coords:a.center};a.markers=[];a.markers.push(a.center);a.$apply()},function(){})};a.gmap=function(b){a.center={latitude:b.map[0],longitude:b.map[1]};a.form.local=b.address;b.check&&(a.markers=[],a.markers.push(a.center))};a.Tags=function(b){return d.post("http://nhadat.com/api/message/tags.html",{content:b}).success(function(b){a.tags=b.tags})};a.Exist=function(){return d.post("http://nhadat.com/api/group/tags.html",{keyword:a.form.name}).success(function(b){a.items=b.results;
a.form.subdomain=b.slug;a.Domain()})};a.Domain=function(){if(2<a.form.subdomain.length)return d.post("http://nhadat.com/api/group/domain.html",{domain:a.form.subdomain}).success(function(b){a.success=0===b.results.length?!0:!1});a.success=!1};a.toggle=function(b){var c=a.form.tag.indexOf(b);-1<c?a.form.tag.splice(c,1):a.form.tag.push(b)};a.suggests=function(){var b=a.form.local;6<b.length?a.busy||(a.busy=!0,d.post("http://nhadat.com/api/address.html",{address:b}).success(function(b){a.results=
b.results;a.busy=!1}).error(function(){a.busy=!1})):a.results=[]};a.submit=function(){a.markers.length&&(a.form.map=a.markers[0].latitude+", "+a.markers[0].longitude);if("undefined"!=typeof a.form.description&&20<=a.form.description.length)return d.post("http://nhadat.com/api/group/create.html",a.form).success(function(a){g.show({type:"success",msg:"B\u1ea1n \u0111\u00e3 t\u1ea1o \u0111\u1ecba danh th\u00e0nh c\u00f4ng."});b(function(){e.path("#/tag/"+a.group.slug+".html")},1E3)}).error(function(b){a.step=
...
markers:[],zoom:11,longitude:null,latitude:null});b.post("http://nhadat.com/api/tag.html",{slug:c.tagId}).success(function(b){a.item=b.data;a.results=new d(a.item.slug);a.stats=b.stats;a.center={latitude:parseFloat(a.item.map[0]),longitude:parseFloat(a.item.map[1])};a.position={coords:{latitude:parseFloat(a.item.map[0]),longitude:parseFloat(a.item.map[1])}};a.markers.push(a.center)}).error(function(b,c){404===c&&(a.item=[])})}]).controller("PostCtrl",["$scope","$http","$routeParams","Auth",function(a,
b,c,d){a.login=d.isLoggedIn();a.user=d.user();angular.extend(a,{position:{coords:{latitude:10.823099,longitude:106.629664}},center:{latitude:0,longitude:0},markers:[],zoom:15,longitude:null,latitude:null});a.submit=function(c){if(d.isLoggedIn())return b.post("http://nhadat.com/api/comment/create.html",{msg_id:c,comment:a.form.comment}).success(function(b){a.item.comments.push(b);a.form={}}).error(function(a){alert("B\u1ea1n ph\u1ea3i \u0111\u0103ng nh\u1eadp \u0111\u1ec3 s\u1eed d\u1ee5ng ch\u1ee9c n\u0103ng n\u00e0y.")});
alert("B\u1ea1n ph\u1ea3i \u0111\u0103ng nh\u1eadp \u0111\u1ec3 s\u1eed d\u1ee5ng ch\u1ee9c n\u0103ng n\u00e0y.")};b.post("http://nhadat.com/api/message/read.html",{id:c.postId}).success(function(b){a.item=b;a.item.meta.map&&(a.center={latitude:parseFloat(a.item.meta.map[0]),longitude:parseFloat(a.item.meta.map[1])},a.position={coords:{latitude:parseFloat(a.item.meta.map[0]),longitude:parseFloat(a.item.meta.map[1])}},a.markers.push(a.center))}).error(function(b,c){404===c&&(a.itemitem=[])})}]).controller("TypeaheadCtrl",
["$scope","$http",function(a,b){a.search=function(){1<a.keyword.length&&b.post("http://nhadat.com/api/search.html",{keyword:a.keyword}).success(function(b){a.results=b}).error(function(b,d){401===d&&(a.results=[])})};a.suggests=function(a){return b.post("/search/typeahead.html",{keyword:a}).then(function(a){return a.data})}}]).controller("ClassifiedCtrl",["$scope","$http","$location","SearchService","Auth",function(a,b,c,d,e){a.isRealEstate=!0;a.isStatus=!0;a.user=e.user();a.isSwitch=function(b){b&&
(a.isStatus||(a.isStatus=!0),a.isRealEstate||(a.isRealEstate=!0));return!b};a.results=new d;b.post("http://nhadat.com/api/stats.html").success(function(b){a.stats=b.stats})}]).controller("ProfileCtrl",["$scope","$http","$routeParams","SearchService","Auth",function(a,b,c,d,e){a.myInterval=6E4;a.isRealEstate=!0;a.isStatus=!0;a.form={};a.user=e.user();b.post("http://nhadat.com/profile.html",{username:c.profileId}).success(function(b){a.user=b.user;a.slides=b.slides;a.stats=b.stats;a.results=
new d({uid:b.user.idu})});a.isSwitch=function(b){b&&(a.isStatus||(a.isStatus=!0),a.isRealEstate||(a.isRealEstate=!0));return!b}}]).controller("SliderCtrl",["$scope","$http",function(a,b){a.slides=[];b.post("http://nhadat.com/api/slider.html").success(function(b){a.slides=b});a.direction="left";a.currentIndex=0;a.setSlide=function(b){a.currentIndex=b};a.isSlide=function(b){return a.currentIndex===b};a.prev=function(){a.direction="left";a.currentIndex=a.currentIndex<a.slides.length-1?++a.currentIndex:
0};a.next=function(){a.direction="right";a.currentIndex=0<a.currentIndex?--a.currentIndex:a.slides.length-1}}]).controller("ContactCtrl",["$scope","$http","$location","$timeout","Flash",function(a,b,c,d,e){a.lastForm={};a.form={};a.disabled=!1;a.submit=function(f){a.lastForm=angular.copy(f);b.post("http://nhadat.com/api/contact.html",{fullname:a.form.fullname,email:a.form.email,select:a.form.select,message:a.form.message}).success(function(b){a.disabled=!0;d(function(){c.path("#/index.html")},
5E3);e.show({type:"success",msg:b.flash})}).error(function(a){e.show({type:"danger",msg:a.flash})})};a.reset=function(){a.form=angular.copy(a.lastForm)}}]).controller("FollowCtrl",["$scope","$http",function(a,b){b.post("http://nhadat.com/api/follows.html").success(function(b){a.follows=b})}]).controller("CommentsCtrl",["$scope","$http","$routeParams","Auth","Flash",function(a,b,c,d,e){a.form={};a.login=d.isLoggedIn();a.user=d.user();angular.extend(a,{position:{coords:{latitude:10.823099,longitude:106.629664}},
center:{latitude:0,longitude:0},markers:[],zoom:17,longitude:null,latitude:null});a.submit=function(c){if(d.isLoggedIn())return b.post("http://nhadat.com/api/comment/create.html",{msg_id:c,comment:a.form.comment}).success(function(b){a.item.comments.push(b);a.form={}}).error(function(a){alert("B\u1ea1n ph\u1ea3i \u0111\u0103ng nh\u1eadp \u0111\u1ec3 s\u1eed d\u1ee5ng ch\u1ee9c n\u0103ng n\u00e0y.")});alert("B\u1ea1n ph\u1ea3i \u0111\u0103ng nh\u1eadp \u0111\u1ec3 s\u1eed d\u1ee5ng ch\u1ee9c n\u0103ng n\u00e0y.")};
b.post("http://nhadat.com/api/message/read.html",{id:c.commentId}).success(function(b){a.item=b;a.item.meta.map&&(a.center={latitude:parseFloat(a.item.meta.map[0]),longitude:parseFloat(a.item.meta.map[1])},a.position={coords:{latitude:parseFloat(a.item.meta.map[0]),longitude:parseFloat(a.item.meta.map[1])}},a.markers.push(a.center))}).error(function(b,c){404===c&&(a.item=[])})}]).controller("LoginCtrl",["$scope","$location","$http","$rootScope","Auth","Flash",function(a,b,c,d,e,f){a.steps=["one",
"two","three","four"];a.step=0;a.credentials={user:"",password:""};a.isFirstStep=function(){return 0===a.step};a.isLastStep=function(){return a.step===a.steps.length-1};a.CurrentStep=function(){return a.steps[a.step]};a.NextLabel=function(){return a.isLastStep()?"\u0110\u0103ng nh\u1eadp":a.isFirstStep()?"Ti\u1ebfp t\u1ee5c":"X\u00e1c nh\u1eadn"};a.Previous=function(){a.step=0};a.Next=function(){a.isFirstStep()?a.email_or_phone():3<a.credentials.password.length&&a.login()};a.email_or_phone=function(){c.post("http://nhadat.com/api/user/status.html",
...
"Flash",function(a,b,c,d,e,f){a.steps=["one","two","three","four"];a.step=0;a.form=e.user();a.isFirstStep=function(){return 0===a.step};a.isLastStep=function(){return a.step===a.steps.length-1};a.CurrentStep=function(){return a.steps[a.step]};a.NextLabel=function(){return a.isLastStep()?"C\u1eadp nh\u1eadp":"Ti\u1ebfp t\u1ee5c"};a.Previous=function(){a.step-=1};a.Next=function(){a.isLastStep()?a.update():a.step+=1};a.update=function(){if(e.isLoggedIn())return b.post("http://nhadat.com/api/user/update.html",
