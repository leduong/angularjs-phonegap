...
{templateUrl:"html/contact.html"});a.when("/sale.html",{templateUrl:"html/sale.html"});a.when("/share.html",{templateUrl:"html/share.html"});a.when("/",{templateUrl:"html/welcome.html",controller:"WelcomeCtrl"});a.otherwise({redirectTo:"/"});d.defaults.headers.common={"X-Requested-With":"XMLHttpRequest"}}]).config(["$httpProvider",function(a){a.responseInterceptors.push(["$location","$q","Session","Flash",function(a,d,c,e){var f=function(a){return a},g=function(g){401===g.status&&(c.unset("authenticated"),
a.path("/login.html"),e.show({type:"error",msg:g.data.flash}));return d.reject(g)};return function(a){return a.then(f,g)}}])}]).config(["$compileProvider",function(a){a.aHrefSanitizationWhitelist(/^\s*(https?|mailto|tel|sms):/)}]).run(["$rootScope","$location","Auth","Flash",function(a,b,d,c){var e=["/diadanh.html","/sale.html","/share.html","/update.html","/account.html"],f=["/diadanh.html","/sale.html"];a.isPath="";a.$on("$routeChangeStart",function(g,h,k){a.isLogin=d.isLoggedIn();a.User=d.user();
a.isMenu=!1;_(e).contains(b.path())&&!a.isLogin&&(a.isPath=b.path(),b.path("/login.html"),c.show({type:"info",msg:"M\u1ee5c n\u00e0y c\u1ea7n ph\u1ea3i \u0111\u0103ng nh\u1eadp \u0111\u1ec3 ti\u1ebfp t\u1ee5c."}));!_(f).contains(b.path())||a.User.phone&&a.User.first_name||(b.path("/update.html"),c.show({type:"info",msg:"\u0110\u1ec3 rao \u0111\u0103ng b\u1ea1n c\u1ea7n ph\u1ea3i c\u1eadp nh\u1eadp t\u00ean v\u00e0 s\u1ed1 \u0111i\u1ec7n tho\u1ea1i."}))})}]),services=angular.module("App.services",
[]).factory("SearchService",["$http","Domain",function(a,b){var d=function(a){this.items=[];this.busy=!1;this.page=1;this.end=!1;this.search=a||[];this.nextPage()};d.prototype.nextPage=function(){this.end||this.busy||(this.busy=!0,this.end||a.post(b+"/api/search",{page:this.page,retina:window.devicePixelRatio,search:this.search}).success(function(a){if(0<a.length){for(var b=0;b<a.length;b++)this.items.push(a[b]);this.page++}else this.end=!0;this.busy=!1}.bind(this)))};return d}]).factory("TagService",
["$http","Domain",function(a,b){var d=function(a){this.items=[];this.busy=!1;this.page=1;this.end=!1;this.search=a||"";this.nextPage()};d.prototype.nextPage=function(){this.end||this.busy||(this.busy=!0,!this.end&&this.search.length&&a.post(b+"/api/search/tag",{page:this.page,retina:window.devicePixelRatio,keyword:this.search}).success(function(a){if(0<a.length){for(var b=0;b<a.length;b++)this.items.push(a[b]);this.page++}else this.end=!0;this.busy=!1}.bind(this)))};return d}]).factory("Flash",["$rootScope",
"$timeout",function(a,b){return{show:function(d){a.flash=d;b(function(){a.flash=""},9E4)},clear:function(){a.flash=""}}}]).factory("Session",function(){return{get:function(a){return localStorage.getItem(a)},set:function(a,b){return localStorage.setItem(a,b)},unset:function(a){return localStorage.removeItem(a)}}}).factory("Auth",["$http","$sanitize","Session","Flash","Domain",function(a,b,d,c,e){var f=function(a){return{user:b(a.user),password:b(a.password)}};return{login:function(b){return a.post(e+
"/api/user/login",f(b)).success(function(a){d.set("user",JSON.stringify(a.user));c.show({type:"success",msg:a.flash})}).error(function(a){c.show({type:"danger",msg:a.flash})})},logout:function(){return a.get(e+"/api/user/logout").success(function(){d.unset("user");c.show({type:"success",msg:"B\u1ea1n \u0111\u00e3 tho\u00e1t ra an to\u00e0n."})})},update:function(a){d.set("user",JSON.stringify(a))},user:function(){return JSON.parse(d.get("user"))},sendmail:function(b){return a.post(e+"/api/user/sendmail",
f(b)).success(function(a){c.show({type:"success",msg:a.flash})}).error(function(a){c.show({type:"danger",msg:a.flash})})},guest:function(){return a.get(e+"/api/user/guest").success(function(a){d.set("guest",a.user)})},isGuest:function(){return d.get("guest")},isLoggedIn:function(){return d.get("user")}}}]);
...
b.navClass=function(b){var c=a.path().substring(1)||"search.html";return b===c?"active":""}}]}}]).directive("slider",function(){return{restrict:"EM",templateUrl:"html/slider.html"}}).directive("comments",function(){return{restrict:"E",templateUrl:"html/comments.html"}}).directive("agent",function(){return{restrict:"EM",templateUrl:"html/agents.html"}}).directive("notice",function(){return{restrict:"EM",templateUrl:"html/notice.html"}}).directive("classifieds",function(){return{restrict:"EM",templateUrl:"html/classifieds.html"}}).directive("follows",
...
!0;a.isStatus=!0;a.isFirst=!0;a.isFollow=!0;a.keyword=[];a.keywords=[];angular.extend(a,{position:{coords:{latitude:10.823099,longitude:106.629664}},center:{latitude:0,longitude:0},markers:[],zoom:15,longitude:null,latitude:null});a.isSwitch=function(b){b&&(a.isStatus||(a.isStatus=!0),a.isRealEstate||(a.isRealEstate=!0));return!b};a.addkeyword=function(b){"undefined"!=typeof b&&(a.keywords.push({text:b}),a.isFollow=!1,a.keyword=a.keywords)};a.search=function(){"undefined"!=typeof a.keyword?d(function(){a.results=
new c(a.keyword)},1E3):a.results=[]};a.suggests=function(c){b.post(e+"/api/search/typeahead",{keyword:c}).then(function(b){a.follows=b.data;a.isFollow=!0})};b.post(e+"/api/search/follows").success(function(b){a.follows=b});a.$watch("keyword",function(){a.item=[];a.results=[];a.stats=[];a.keyword.length?b.post(e+"/api/search/nero",{keyword:a.keyword}).success(function(b){a.isFirst=!1;a.isFollow=!1;a.item=b.data;a.results=new c(a.item.slug);a.stats=b.stats;a.item.map&&(a.center={latitude:parseFloat(a.item.map[0]),
longitude:parseFloat(a.item.map[1])},a.position={coords:{latitude:parseFloat(a.item.map[0]),longitude:parseFloat(a.item.map[1])}},a.markers.push(a.center))}):a.isFirst=!0})}]).controller("ClassifiedCtrl",["$scope","$http","$location","SearchService","Auth","Domain",function(a,b,d,c,e,f){a.isRealEstate=!0;a.isStatus=!0;a.user=e.user();a.isSwitch=function(b){b&&(a.isStatus||(a.isStatus=!0),a.isRealEstate||(a.isRealEstate=!0));return!b};a.results=new c;b.post(f+"/api/stats").success(function(b){a.stats=
b.stats})}]).controller("ProfileCtrl",["$scope","$http","$routeParams","SearchService","Auth","Domain",function(a,b,d,c,e,f){a.myInterval=6E4;a.isRealEstate=!0;a.isStatus=!0;a.form={};a.user=e.user();b.post(f+"/profile.html",{username:d.profileId}).success(function(b){a.user=b.user;a.slides=b.slides;a.stats=b.stats;a.results=new c({uid:b.user.idu})});a.isSwitch=function(b){b&&(a.isStatus||(a.isStatus=!0),a.isRealEstate||(a.isRealEstate=!0));return!b}}]).controller("SliderCtrl",["$scope","$interval",
"$http","Domain",function(a,b,d,c){a.slides=[];d.post(c+"/api/slider").success(function(b){a.slides=b});a.direction="left";a.currentIndex=0;a.setSlide=function(b){a.currentIndex=b};a.isSlide=function(b){return a.currentIndex===b};a.prev=function(){a.direction="left";a.currentIndex=a.currentIndex<a.slides.length-1?++a.currentIndex:0};a.next=function(){a.direction="right";a.currentIndex=0<a.currentIndex?--a.currentIndex:a.slides.length-1};b(function(){a.currentIndex=a.currentIndex<a.slides.length-1?
++a.currentIndex:0},5E3)}]).controller("ContactCtrl",["$scope","$http","$location","$timeout","Flash","Domain",function(a,b,d,c,e,f){a.lastForm={};a.form={};a.disabled=!1;a.submit=function(g){a.lastForm=angular.copy(g);b.post(f+"/api/contact",{fullname:a.form.fullname,email:a.form.email,select:a.form.select,message:a.form.message}).success(function(b){a.disabled=!0;c(function(){d.path("/index.html")},5E3);e.show({type:"success",msg:b.flash})}).error(function(a){e.show({type:"danger",msg:a.flash})})};
a.reset=function(){a.form=angular.copy(a.lastForm)}}]).controller("FollowCtrl",["$scope","$http","Domain",function(a,b,d){b.post(d+"/api/follows").success(function(b){a.follows=b})}]).controller("CommentsCtrl",["$scope","$http","$routeParams","Auth","Flash","Domain",function(a,b,d,c,e,f){a.form={};a.login=c.isLoggedIn();a.user=c.user();angular.extend(a,{position:{coords:{latitude:10.823099,longitude:106.629664}},center:{latitude:0,longitude:0},markers:[],zoom:17,longitude:null,latitude:null});a.submit=
function(d){if(c.isLoggedIn())return b.post("/api/comment/create",{msg_id:d,comment:a.form.comment}).success(function(b){a.item.comments.push(b);a.form={}}).error(function(a){alert("B\u1ea1n ph\u1ea3i \u0111\u0103ng nh\u1eadp \u0111\u1ec3 s\u1eed d\u1ee5ng ch\u1ee9c n\u0103ng n\u00e0y.")});alert("B\u1ea1n ph\u1ea3i \u0111\u0103ng nh\u1eadp \u0111\u1ec3 s\u1eed d\u1ee5ng ch\u1ee9c n\u0103ng n\u00e0y.")};b.post(f+"/api/message/read",{id:d.commentId}).success(function(b){a.item=b;a.item.meta.map&&(a.center=
...
a.step};a.isLastStep=function(){return a.step===a.steps.length-1};a.CurrentStep=function(){return a.steps[a.step]};a.NextLabel=function(){return a.isLastStep()?"\u0110\u0103ng nh\u1eadp":a.isFirstStep()?"Ti\u1ebfp t\u1ee5c":"X\u00e1c nh\u1eadn"};a.Previous=function(){a.step=0};a.Next=function(){a.isFirstStep()?a.email_or_phone():3<a.credentials.password.length?a.login():g.show({type:"danger",msg:"M\u1eadt kh\u1ea9u/M\u00e3 x\u00e1c nh\u1eadn qu\u00e1 ng\u1eafn."})};a.email_or_phone=function(){d.post(h+
"/api/user/status",{user:a.credentials.user}).success(function(b){a.step=a.steps.length-1;a.phone="phone"==b.user;a.email="email"==b.user;b.flash&&g.show({type:"info",msg:b.flash})}).error(function(b,c){404==c?("phone"==b.user?a.step=1:"email"==b.user&&(a.step=2),b.flash&&g.show({type:"danger",msg:b.flash})):(a.step=0,g.show({type:"danger",msg:"Email ho\u1eb7c s\u1ed1 \u0111i\u1ec7n tho\u1ea1i kh\u00f4ng h\u1ee3p l\u1ec7."}))})};a.resetpw=function(){f.sendmail(a.credentials).error(function(){a.step=
...
c("tel")(a.form.phone)});a.verify=function(){return b.post(g+"/api/user/verify",a.form).success(function(b){f.show({type:"success",msg:b.flash});b.phone&&(a.phone=!0,a.email=!1);b.email&&(a.phone=!1,a.email=!0)}).error(function(a){f.show({type:"danger",msg:a.flash})})};a.confirm=function(){return b.post(g+"/api/user/confirm",a.form).success(function(a){f.show({type:"success",msg:a.flash});e.update(a.user);d.path("/index.html")}).error(function(a){f.show({type:"danger",msg:a.flash})})};a.submit=function(){if(e.isLoggedIn())return b.post(g+
"/api/user/update",a.form).success(function(b){f.show({type:"success",msg:b.flash});e.update(b.user);a.user=e.user();a.name=!1}).error(function(b){f.show({type:"danger",msg:b.flash});a.user=e.user()});f.show({type:"danger",msg:"B\u1ea1n ch\u01b0a \u0111\u0103ng nh\u1eadp, vui l\u00f2ng \u0111\u0103ng nh\u1eadp."})};a.password=function(){if(e.isLoggedIn()){if("undefined"!=typeof a.form.password&&6<=a.form.password.length)return b.post(g+"/api/user/update",a.form).success(function(b){f.show({type:"success",
msg:b.flash});e.update(b.user);a.passwd=!1}).error(function(a){f.show({type:"danger",msg:a.flash})});f.show({type:"danger",msg:"M\u1eadt kh\u1ea9u \u00edt nh\u1ea5t 6 k\u00fd t\u1ef1."})}else f.show({type:"danger",msg:"B\u1ea1n ch\u01b0a \u0111\u0103ng nh\u1eadp, vui l\u00f2ng \u0111\u0103ng nh\u1eadp."})}}]).controller("NewPasswordCtrl",["$scope","$http","$location","Auth","Flash","Domain",function(a,b,d,c,e,f){a.update=function(){if(c.isLoggedIn()){if("undefined"!=typeof a.form.password&&6<=a.form.password.length)return b.post(f+
"/api/user/update",a.form).success(function(a){c.update(a.user);d.path("/index.html");e.show({type:"success",msg:a.flash})}).error(function(a){e.show({type:"danger",msg:a.flash})});e.show({type:"danger",msg:"M\u1eadt kh\u1ea9u \u00edt nh\u1ea5t 6 k\u00fd t\u1ef1."})}else e.show({type:"danger",msg:"B\u1ea1n ch\u01b0a \u0111\u0103ng nh\u1eadp, vui l\u00f2ng \u0111\u0103ng nh\u1eadp."})}}]).animation(".slide-animation",function(){return{addClass:function(a,b,d){var c=a.scope();"ng-hide"==b?(b=a.parent().width(),
"right"!==c.direction&&(b=-b),TweenMax.to(a,0.5,{left:b,onComplete:d})):d()},removeClass:function(a,b,d){var c=a.scope();"ng-hide"==b?(a.removeClass("ng-hide"),b=a.parent().width(),"right"===c.direction&&(b=-b),TweenMax.set(a,{left:b}),TweenMax.to(a,0.5,{left:0,onComplete:d})):d()}}});
